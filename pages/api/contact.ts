...
import { dev, geoip2Id } from '@/config/index'
import url from 'url'
import http from 'http'
import { v4 as uuidv4 } from 'uuid'
import moment from 'moment'
import { WebServiceClient } from '@maxmind/geoip2-node'
import emailTemplateIPO from '@/components/EmailTemplates/emailTemplateIPO'
...
export default async (req, res) => {
  ...
  // geoip2 init
  const geoip2 = new WebServiceClient(geoip2Id, process.env.GEO2_APIKEY, {
    host: 'geolite.info'
  })
